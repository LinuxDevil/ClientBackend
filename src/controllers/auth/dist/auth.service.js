...
var AuthService = /** @class */ (function () {
    function AuthService(userRepo, jwtService, smsService) {
    ...
    AuthService.prototype.verify = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.smsService.checkVerification(code.username, code.code)];
                    case 1:
                        response = _a.sent();
                        if (!(response && response === 'approved')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.smsService.sendSMS(code.username, "Hello, Welcome to My Clinic App")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {
                                message: 'Approved!',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, this.userRepo.findOne({ where: { email: credentials.email } })];
                    case 1:
                        user = _a.sent();
