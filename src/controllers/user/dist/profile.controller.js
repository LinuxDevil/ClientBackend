...
var optional_auth_guard_1 = require("src/guards/optional-auth.guard");
var user_decorator_1 = require("src/decorators/user.decorator");
var ProfileController = /** @class */ (function () {
    function ProfileController(userService) {
        this.userService = userService;
    }
    ProfileController.prototype.findProfile = function (username, user) {
        return __awaiter(this, void 0, void 0, function () {
            var profile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findByUsername(username, user)];
                    case 1:
                        profile = _a.sent();
                        if (!profile) {
    ...
    __decorate([
        ...
        __param(0, common_1.Param('username')), __param(1, user_decorator_1.User())
    ], ProfileController.prototype, "findProfile");
    __decorate([
        common_1.Post('/:username/follow'),
        common_1.HttpCode(200),
        common_1.UseGuards(passport_1.AuthGuard()),
        __param(0, user_decorator_1.User()), __param(1, common_1.Param('username'))
    ], ProfileController.prototype, "followUser");
    __decorate([
        common_1.Delete('/:username/unfollow'),
        common_1.UseGuards(passport_1.AuthGuard()),
        __param(0, user_decorator_1.User()), __param(1, common_1.Param('username'))
