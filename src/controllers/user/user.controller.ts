import { Body, Controller, Get, Post, Put, UnauthorizedException, UseGuards, ValidationPipe } from '@nestjs/common';
...
export class UserController {
    ...
    @Post('/addSub')
    @UseGuards(AuthGuard())
    addSubUser(@User() user: UserEntity, @Body() subUsername: {username: string, subUsername: string} ) {
