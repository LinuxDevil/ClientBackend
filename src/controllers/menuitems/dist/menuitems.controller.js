...
var MenuitemsController = /** @class */ (function () {
    function MenuitemsController(menuItemService) {
        this.menuItemService = menuItemService;
    }
    MenuitemsController.prototype.addMenuItem = function (menuItem) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menuItemService.addMenuItem(menuItem)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    MenuitemsController.prototype.updateMenuItem = function (menuItem, menuItemId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menuItemService.updateMenuItem(menuItemId, menuItem)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    MenuitemsController.prototype.addSubMenuItem = function (menuItem) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menuItemService.addSubMenuItem(menuItem)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    MenuitemsController.prototype.deleteMenuItem = function (menuItem) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.menuItemService.removeMenuItem(menuItem.menuItemId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        common_1.Post('/sub'),
        __param(0, common_1.Body())
    ], MenuitemsController.prototype, "addSubMenuItem");
    __decorate([
        common_1.Delete(),
        __param(0, common_1.Body())
