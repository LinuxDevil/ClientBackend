...
var DistrictEntity = /** @class */ (function (_super) {
    __extends(DistrictEntity, _super);
    function DistrictEntity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        typeorm_1.Column()
    ], DistrictEntity.prototype, "nameAr");
    __decorate([
        typeorm_1.Column()
    ], DistrictEntity.prototype, "nameEn");
    __decorate([
        typeorm_1.ManyToOne(function () { return city_entity_1.CityEntity; }, function (city) { return city.id; }),
        typeorm_1.JoinTable()
    ], DistrictEntity.prototype, "city");
    DistrictEntity = __decorate([
        typeorm_1.Entity('district')
    ], DistrictEntity);
