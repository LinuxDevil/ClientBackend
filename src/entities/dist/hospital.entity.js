...
var HospitalEntity = /** @class */ (function (_super) {
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return place_entity_1.PlaceEntity; }, function (place) { return place.id; }),
        typeorm_1.JoinTable()
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return HospitalEntity_1; }, function (hospital) { return hospital.id; }),
        typeorm_1.JoinTable()
