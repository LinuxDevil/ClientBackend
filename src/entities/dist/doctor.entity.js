...
var DoctorEntity = /** @class */ (function (_super) {
    ...
    DoctorEntity.prototype.hashPassword = function () {
    ...
    DoctorEntity.prototype.comparePassword = function (password) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DoctorEntity.prototype.toProfile = function (user) {
        var patients = null;
        var profile = this.toJSON();
        delete profile.patients;
        return __assign(__assign({}, profile), { patients: patients });
    };
    DoctorEntity.prototype.toJSON = function () {
        return class_transformer_1.classToPlain(this);
    };
    __decorate([
        typeorm_1.Column()
    ], DoctorEntity.prototype, "email");
    __decorate([
        typeorm_1.Column()
    ], DoctorEntity.prototype, "username");
    __decorate([
        typeorm_1.Column({ "default": '' })
    ], DoctorEntity.prototype, "phone");
    __decorate([
        typeorm_1.Column({ "default": '' })
    ...
    ], DoctorEntity.prototype, "password");
    __decorate([
        typeorm_1.Column({ "default": 8, nullable: true })
    ], DoctorEntity.prototype, "shiftDuration");
    __decorate([
        typeorm_1.Column({ "default": '10', nullable: true })
    ], DoctorEntity.prototype, "duration");
    __decorate([
        typeorm_1.Column('text', { array: true, nullable: true })
    ], DoctorEntity.prototype, "appointmentTimes");
    __decorate([
        typeorm_1.Column('text', { array: true, nullable: true })
    ], DoctorEntity.prototype, "appointmentDurations");
    __decorate([
        typeorm_1.Column('text', { array: true, nullable: true })
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return appointment_entity_1.AppointmentEntity; }, function (appointment) { return appointment.doctor; }),
        typeorm_1.JoinTable()
    ...
    __decorate([
        ...
        typeorm_1.JoinTable()
    ], DoctorEntity.prototype, "patients");
    __decorate([
